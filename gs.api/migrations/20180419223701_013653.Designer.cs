...
namespace gs.api.Migrations
{
    ...
    [Migration("20180419223701_013653")]
    partial class _013653
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("gs.api.storage.model.resellers.dicts.spec.BoolSpecification", b =>
                {
                    b.HasBaseType("gs.api.storage.model.resellers.dicts.spec.Specification");


                    b.ToTable("BoolSpecification");

                    b.HasDiscriminator().HasValue("BoolSpecification");
                });

            modelBuilder.Entity("gs.api.storage.model.resellers.dicts.spec.ColorSpecification", b =>
                {
                    b.HasBaseType("gs.api.storage.model.resellers.dicts.spec.Specification");


                    b.ToTable("ColorSpecification");

                    b.HasDiscriminator().HasValue("ColorSpecification");
                });

            modelBuilder.Entity("gs.api.storage.model.resellers.dicts.spec.NumberSpecification", b =>
                {
                    b.HasBaseType("gs.api.storage.model.resellers.dicts.spec.Specification");

                    b.Property<string>("UnitOfMeasure");

                    b.ToTable("NumberSpecification");

                    b.HasDiscriminator().HasValue("NumberSpecification");
                });

            modelBuilder.Entity("gs.api.storage.model.resellers.dicts.spec.StringSpecification", b =>
                {
                    b.HasBaseType("gs.api.storage.model.resellers.dicts.spec.Specification");


                    b.ToTable("StringSpecification");

                    b.HasDiscriminator().HasValue("StringSpecification");
                });
